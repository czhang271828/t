    ...
    \begin{enumerate}
        ...
        \item 有同伦等价的交换图
              ...
              \[\begin{tikzcd}
                  ...
                  \end{tikzcd}.\]
        \item 对任意 Abel 范畴复形的短正合列 $\begin{tikzcd}
                      0 & X & Y & Z & 0
                      \arrow[from=1-1, to=1-2]
                      \arrow["u", from=1-2, to=1-3]
                      \arrow["v", from=1-3, to=1-4]
                      \arrow[from=1-4, to=1-5]
                  \end{tikzcd}$, 有拟同构 $\begin{pmatrix}-u\\0\end{pmatrix}: X\to \mathrm{cone}(v)[-1]$, 如以下正合列的交换图所示
              % https://q.uiver.app/#q=
              \[\begin{tikzcd}
                      0 & X & Y & Z & 0 \\
                      0 & {\mathrm{cone}(v)[-1]} & {\mathrm{him}(v)} & Z & 0
                      \arrow[from=1-1, to=1-2]
                      ...
                      \arrow["v", from=1-3, to=1-4]
                      \arrow[Rightarrow, no head, from=1-4, to=2-4]
                      \arrow["{\left(\substack{v\\-1\\0}\right)}"', from=1-3, to=2-3]
                      \arrow["{\left(\substack{-u\\0}\right)}"', from=1-2, to=2-2]
                  \end{tikzcd}.\]
    \end{enumerate}
\end{proposition}

\begin{proposition}[$H^n$ 是上同调函子]
    给定同伦范畴 $K(\mathcal A)$, 则任一 $\mathrm H^n$ 将好三角映作正合列. 三角射诱导的长正合列之连接态射自然.
    \begin{proof}
        对任意 $K(\mathcal A)$ 中好三角 $\begin{tikzcd}
                X & Y & {\mathrm{cone}(u)} & {X[1]}
                \arrow["u", from=1-1, to=1-2]
                \arrow["\binom01", from=1-2, to=1-3]
                \arrow["{(1,0)}", from=1-3, to=1-4]
            \end{tikzcd}$, 既证同伦交换图% https://q.uiver.app/#q=
        \[\begin{tikzcd}
                X & Y & Z & {X[1]} \\
                {X'} & {Y'} & {\mathrm{cone}(u')} & {X'[1]} \\
                {X'} & {\mathrm{cyl}(u')} & {\mathrm{cone}(u')} & {X[1]}
                \arrow["u", from=1-1, to=1-2]
                \arrow["{\left(\substack{0\\0\\1}\right)}"', from=3-1, to=3-2]
                \arrow["v", from=1-2, to=1-3]
                \arrow["w", from=1-3, to=1-4]
                \arrow["{\binom{1\,\,0\,\,0}{0\,\,1\,\,0}}"', from=3-2, to=3-3]
                \arrow["{(1,0)}"', from=3-3, to=3-4]
                \arrow["f"', from=1-1, to=2-1]
                \arrow["g"', from=1-2, to=2-2]
                \arrow["h"', from=1-3, to=2-3]
                \arrow["{f[1]}", from=1-4, to=2-4]
                \arrow[Rightarrow, no head, from=2-1, to=3-1]
                \arrow["{(0,1,u)}", from=3-2, to=2-2]
                \arrow[Rightarrow, no head, from=3-4, to=2-4]
                \arrow["{u'}", from=2-1, to=2-2]
                \arrow["\binom01", from=2-2, to=2-3]
                \arrow["{(1,0)}", from=2-3, to=2-4]
                \arrow[Rightarrow, no head, from=3-3, to=2-3]
            \end{tikzcd}.\]
        作用任一 $\mathrm H^n$ 函子, 得
        % https://q.uiver.app/#q=
        \[\begin{tikzcd}
                {\mathrm H^n(X)} & {\mathrm H^n(Y)} & {\mathrm H^n(Z)} \\
                {\mathrm H^n(X')} & {\mathrm H^n(Y')} & {\mathrm H^n(\mathrm{cone}(u'))} \\
                {\mathrm H^n(X')} & {\mathrm H^n(\mathrm{cyl}(u'))} & {\mathrm H^n(\mathrm{cone}(u'))}
                \arrow["{\left(\substack{0\\0\\1}\right)}"', from=3-1, to=3-2]
                \arrow["v", from=1-2, to=1-3]
                \arrow["{\binom{1\,\,0\,\,0}{0\,\,1\,\,0}}"', from=3-2, to=3-3]
                \arrow[Rightarrow, no head, from=2-1, to=3-1]
            ...
            \end{tikzcd}.\]
        其中, 最后一行为可裂短正合列, $\sim$ 表示同伦等价在 $\mathrm H^n$ 下的像, 即同构. 因此前两行均正合. 对任意三角射
        % https://q.uiver.app/#q=
        \[\begin{tikzcd}
                \cdots & {\mathrm H^n(X[-1])} && {\mathrm H^n(X)} & {\mathrm H^n(Y)} & {\mathrm H^n(Z)} & {\mathrm H^n(X[1])} & {\cdots } \\
                \dots & {\mathrm H^n(X'[-1])} && {\mathrm H^n(X')} & {\mathrm H^n(Y')} & {\mathrm H^n(Z')} & {\mathrm H^n(X'[1])} & \cdots
                \arrow["{\mathrm H^n(v)}", from=1-5, to=1-6]
                \arrow["{\mathrm H^n(u')}"', from=2-4, to=2-5]
                \arrow["{\mathrm H^n(v')}"', from=2-5, to=2-6]
                \arrow["{\mathrm H^n(h)}", from=1-6, to=2-6]
                \arrow["{\mathrm H^n(g)}", from=1-5, to=2-5]
                \arrow["{\mathrm H^n(f)}", from=1-4, to=2-4]
                \arrow["{\mathrm H^n(u)}", from=1-4, to=1-5]
                \arrow["{\mathrm H^n(w)}", from=1-6, to=1-7]
                \arrow["{\mathrm H^n(w')}"', from=2-6, to=2-7]
                \arrow["{\mathrm H^n(f[1])}", from=1-7, to=2-7]
                \arrow[from=1-7, to=1-8]
                \arrow[from=2-7, to=2-8]
                \arrow["{\mathrm H^n(-w[-1])}", from=1-2, to=1-4]
                \arrow["{\mathrm H^n(-w'[-1])}"', from=2-2, to=2-4]
                \arrow["{\mathrm H^n(h[-1])}", from=1-2, to=2-2]
                \arrow[from=1-1, to=1-2]
                \arrow[from=2-1, to=2-2]
            \end{tikzcd}.\]
        其中, 任一 $\mathrm H^n(-)$ 函子将同伦交换图映作 Abel 范畴的交换图.
    \end{proof}
\end{proposition}
